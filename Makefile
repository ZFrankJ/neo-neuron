...
lstm-parity:
	$(PYTHON) -m pytest -q tests/test_lstm_init_controls.py tests/test_lstm_forward_parity.py tests/test_lstm_training_parity.py tests/test_scheduler_timing.py
